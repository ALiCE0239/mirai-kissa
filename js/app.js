...
(function () {
  ...
  function initRouter() {
    ...
    router
      ...
      .add('/guides/articles/:id', 'tmpl-guides-article', withScripts(['guides'], (params) => GuidesPage.initArticle(params)))
      ...
      .add('/mypage',   'tmpl-mypage',    withScripts(['mypage'], () => guardCommunity(() => MiraiMyPage.initMyPage())()))
      ...
      .add('/mypage/sekainote', 'tmpl-mypage-sekainote', withScripts(['mypage', 'board'], () => guardCommunity(() => MiraiMyPage.initSekaiNoteEdit())()))
      .add('/mypage/profile-card', 'tmpl-profile-card', withScripts(['mypage'], () => guardCommunity(() => MiraiMyPage.initProfileCard())()))
      .add('/mypage/ranking', 'tmpl-ranking-hub', withScripts(['mypage', 'ranking'], () => guardCommunity(() => MiraiRanking.initMypageHub())()))
      .add('/mypage/ranking/:type', 'tmpl-ranking-edit', withScripts(['mypage', 'ranking'], (params) => guardCommunity(() => MiraiRanking.initEdit(params))()))
      .add('/mypage/event-support', 'tmpl-mypage-event-support', withScripts(['eventSupport'], () => guardCommunity(() => MiraiEventSupport.initHub())()))
      .add('/mypage/event-support/:id/report', 'tmpl-mypage-event-report', withScripts(['eventSupportLite', 'guides'], (params) => guardCommunity(() => GuidesPage.initReportEditor(params))()))
      ...
      .add('/p/:id',    'tmpl-public',    withScripts(['mypage', 'board'], (params) => MiraiMyPage.initPublic(params)))
